...
```{r}
Acoustic_Survey_old <-
  read_csv('Data/FulcrumDataExports/Fulcrum_Export_e9d9f1d9-dd61-4d04-a39c-e28cee0e156f/ple_acoustic_survey/ple_acoustic_survey.csv') %>% 
  group_by(fulcrum_id) %>% 
  top_n(1, version) %>% 
...
Acoustic_Survey_Repeatable_old <-
  read_csv('Data/FulcrumDataExports/Fulcrum_Export_e9d9f1d9-dd61-4d04-a39c-e28cee0e156f/ple_acoustic_survey/ple_acoustic_survey_acoustic_survey.csv') %>%
  group_by(fulcrum_id) %>% 
  top_n(1, version) %>% 
  ungroup() %>%
...
Amphibian_Captured_Information_old <-
  read_csv('Data/FulcrumDataExports/Fulcrum_Export_e9d9f1d9-dd61-4d04-a39c-e28cee0e156f/ple_captured_amphibian_information/ple_captured_amphibian_information.csv') %>% 
  group_by(fulcrum_id) %>% 
  top_n(1, version) %>% 
  filter(change_type != 'delete') %>% view()
  ungroup() %>% 
...
Amphibian_Captured_Information_Repeatable_old <-
  read_csv('Data/FulcrumDataExports/Fulcrum_Export_e9d9f1d9-dd61-4d04-a39c-e28cee0e156f/ple_captured_amphibian_information/ple_captured_amphibian_information_captured_amphibian_information.csv') %>%
  group_by(fulcrum_id) %>% 
  top_n(1, version) %>% 
...
VisualEncounter_Survey_old <-
  read_csv("Data/FulcrumDataExports/Fulcrum_Export_e9d9f1d9-dd61-4d04-a39c-e28cee0e156f/ple_visual_encounter_survey/ple_visual_encounter_survey.csv")  %>%
  group_by(fulcrum_id) %>% 
  top_n(1, version) %>% 
  select(fulcrum_id, created_at, observer, observer_other, date, location, start_time, end_time) %>% unique() 

VisualEncounter_Survey_Repeatable_old <-
  read_csv('Data/FulcrumDataExports/Fulcrum_Export_e9d9f1d9-dd61-4d04-a39c-e28cee0e156f/ple_visual_encounter_survey/ple_visual_encounter_survey_visual_encounter_information.csv')  %>%
  group_by(fulcrum_id) %>% 
  top_n(1, version) %>% 
